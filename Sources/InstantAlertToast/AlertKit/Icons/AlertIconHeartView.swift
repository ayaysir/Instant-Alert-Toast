...
internal class AlertIconHeartView: UIView {
  ...
  class HeartDraw: NSObject {
    ...
    @objc dynamic internal class func draw(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 510, height: 470), resizing: ResizingBehavior = .aspectFit, fillColor: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
